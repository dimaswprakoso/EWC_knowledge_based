...
# ----------------------------------------------------------------------------#
sql = "TRUNCATE TABLE word_sim_sample"
try:
    cursor.execute(sql)
    cnx.commit()
...
for first_word in all_unique_words:
    for second_word in all_unique_words:
        ...
        rows.append(row)
        # sql = 'INSERT INTO word_sim_sample(word1, word2, similarity) VALUES ("{}","{}",{})'.format (first_word,second_word, word_sim)

sql = """INSERT INTO word_sim_sample(word1, word2, similarity) VALUES (%s, %s, %s)"""
